...
$pdf->Image("../../assets/img/logo.png", 180, 5, 25, 25, 'PNG');
...
$pdf->Cell(196, 5, "Datos del operario", 1, 1, 'C', 1);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(90, 5, utf8_decode('Nombre'), 0, 0, 'L');
$pdf->Cell(50, 5, utf8_decode('Sector'), 0, 0, 'L');
$pdf->Cell(56, 5, utf8_decode('Cargo'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 10);
